    ...
    <main>
      ...
      <section id="why" style={{ ...styles.section, background: '#f8f7f4' }}>
        <div style={styles.sectionInner}>
          ...
          <img
            src="/evin-sign.jpg"
            alt="Evin Electric LLC sign in Hatboro PA"
                ...
                <tbody>
                  {hours.map((h, i) => (
                    <tr key={i} style={h.today ? styles.todayRow : styles.hourRow}>
                      <td style={{ ...styles.hourDay, color: h.today ? '#F5A623' : '#B5D4F4' }}>
                        {h.today && <span style={styles.todayDot} />}
                        {h.day}
                      </td>
                      <td style={{ ...styles.hourTime, color: h.today ? '#F5A623' : 'white' }}>{h.time}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={styles.formGroup}>
                  ...
                  <textarea style={{ ...styles.formInput, height: '90px', resize: 'none' }}
...
const styles: Record<string, React.CSSProperties> = {
  nav: {
    ...
    padding: '1rem 2rem', background: '#0a1525', position: 'sticky', top: 0, zIndex: 100,
  },
  navLogo: { display: 'flex', alignItems: 'center', gap: '10px' },
  bolt: {
    width: '34px', height: '34px', background: '#F5A623', borderRadius: '8px',
    display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', color: '#0a1525',
  },
  ...
  navCta: { background: '#F5A623', color: '#0a1525', padding: '8px 20px', borderRadius: '6px', fontSize: '14px', fontWeight: 600 },

  // HERO - background image with overlay
  hero: {
    position: 'relative',
    backgroundImage: 'url(/evin-sign.jpg)',
  ...
  badge: {
    ...
    background: 'rgba(245,166,35,0.12)', color: '#F5A623', fontSize: '12px',
    padding: '5px 14px', borderRadius: '20px', border: '1px solid rgba(245,166,35,0.25)',
    marginBottom: '1.5rem', letterSpacing: '0.04em',
  },
  badgeDot: { width: '6px', height: '6px', background: '#F5A623', borderRadius: '50%', display: 'inline-block' },
  heroH1: {
    fontSize: 'clamp(28px, 5vw, 44px)', fontWeight: 500, color: 'white',
    lineHeight: 1.2, marginBottom: '1.2rem', fontFamily: 'Georgia, serif',
  },
  ...
  btnPrimary: { background: '#F5A623', color: '#0a1525', padding: '13px 28px', borderRadius: '8px', fontSize: '15px', fontWeight: 600 },
  btnOutline: { background: 'transparent', color: 'white', padding: '13px 28px', borderRadius: '8px', fontSize: '15px', border: '1px solid rgba(255,255,255,0.2)' },
  statsRow: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '2rem', gap: '1rem' },
  ...
  sectionLabel: { fontSize: '11px', fontWeight: 600, color: '#F5A623', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '0.5rem' },
  sectionTitle: { fontSize: 'clamp(22px, 4vw, 32px)', fontWeight: 500, color: '#0C1A2E', marginBottom: '0.75rem', fontFamily: 'Georgia, serif' },
  sectionSub: { fontSize: '15px', color: '#555', lineHeight: 1.8, maxWidth: '560px', marginBottom: '2.5rem' },
  servicesGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' },
  serviceCard: { background: '#fff', border: '1px solid #eee', borderRadius: '12px', padding: '1.5rem' },
  serviceIcon: { width: '44px', height: '44px', background: '#FFF3D6', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem' },
  ...
  whyGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginTop: '1.5rem' },
  whyCard: { background: '#fff', borderRadius: '12px', padding: '1.5rem', border: '1px solid #eee' },
  ...
  contactGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', maxWidth: '960px', margin: '0 auto' },
  contactH2: { fontSize: 'clamp(22px, 4vw, 32px)', fontWeight: 500, color: 'white', marginBottom: '1rem', fontFamily: 'Georgia, serif' },
  ...
  hoursHeader: { fontSize: '13px', color: '#B5D4F4', fontWeight: 500, marginBottom: '0.75rem', display: 'flex', alignItems: 'center', gap: '8px' },
  openBadge: { background: 'rgba(29,158,117,0.2)', color: '#5DCAA5', fontSize: '11px', padding: '2px 10px', borderRadius: '20px', border: '1px solid rgba(93,202,165,0.3)' },
  ...
  hourDay: { padding: '9px 0', fontSize: '13px', width: '50%' },
  hourTime: { padding: '9px 0', fontSize: '13px', textAlign: 'right' },
  todayDot: { display: 'inline-block', width: '6px', height: '6px', background: '#F5A623', borderRadius: '50%', marginRight: '8px' },

  formCard: { background: 'white', borderRadius: '16px', padding: '2rem' },
  ...
  formInput: { border: '1px solid #e0e0e0', borderRadius: '8px', padding: '10px 14px', fontSize: '14px', color: '#111', outline: 'none', width: '100%' },
  submitBtn: { width: '100%', background: '#F5A623', color: '#0a1525', padding: '13px', borderRadius: '8px', fontSize: '15px', fontWeight: 600, border: 'none' },
  formNote: { fontSize: '11px', color: '#888', marginTop: '10px', textAlign: 'center' },
  successMsg: { textAlign: 'center', padding: '3rem 1rem', color: '#0C1A2E' },

  footer: { background: '#060F1C', padding: '1.5rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' },
